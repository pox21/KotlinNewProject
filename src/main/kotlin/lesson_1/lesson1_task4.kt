...
fun main() {
//    Запиши в переменные соответствующие значения,
//    явно указывая их тип. Для всех переменных выбирай тип данных,
//    занимающий наименьшее возможное место в памяти,
...
//    Апогей орбиты – 327000
    ...
    val lengthMillimeters: Long = 40_868_600_000
    val age: Byte = 27
    val partOfDay: Float = 0.075f
    val secondsSpace: Short = 6480
    val partOfYear: Double = 2.0547945205479453E-4
    val orbitMeters: Int = 327000

    println("Данные для задачи:")
    println("Расстояние - $lengthMillimeters")
    println("Возраст - $age")
    println("Часть дня - $partOfDay")
    println("Секунды - $secondsSpace")
    println("Часть года - $partOfYear")
    println("Апогей орбиты - $orbitMeters")
}